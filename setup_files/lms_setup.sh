...
wget https://downloads.slimdevices.com/nightly/logitechmediaserver_8.5.0~1710132345_amd64.deb &>/dev/null

echo -e "${CHECKMARK} \e[1;92m Installing Logitech Media Server... \e[0m"
sudo apt install -y ./logitechmediaserver_8.5.0~1710132345_amd64.deb  &>/dev/null
